...
def load_data(args):
    ...
    data_df = pd.read_csv(os.path.join(args.data_dir, 'driving_log.csv'), names=['center', 'left', 'right', 'steering', 'throttle', 'reverse', 'speed', 'rpm', 'sens1', 'sens2', 'sens3', 'sens4'
...
def train_model(model, args, X_train, X_valid, y_train, y_valid):
    ...
    Train the model
    """
    checkpoint = ModelCheckpoint('modelBehavioral-{epoch:03d}.h5',
                                 monitor='val_loss',
                                 verbose=0,
    ...
    plot_model(model, to_file='modelBehavioral.png', show_shapes=True)
...
def main():
    ...
    filename = open("pltdataforbehavioral" + ".pickle","wb")
